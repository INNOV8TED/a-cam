...
const S_internal = {
  ...
  processedHeroImage: null, // 🔥 Cached sharp version with BG removal applied
  ...
  charXOffset: 0.0,       // Horizontal offset (0.0 to 1.0 fraction of width)
  charYOffset: 0.0,       // Vertical offset (0.0 to 1.0 fraction of height)
  charScale: 1.0,         // Overall subject scale multiplier
  subjectAction: '',
  subjectOutfit: '',
  actionTimeline: '',
  masterCharacterSheet: null
};
