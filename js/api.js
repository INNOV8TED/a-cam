...
function handleRenderSuccess(videoUrl) {
    ...
    if (overlay && video) {
        ...
        link.href = videoUrl;
        link.download = `acam_render_${Date.now()}.mp4`;
...
// Configuration panel data binding is now handled centrally in ui.js via Persistence.loadConfig()
...
// Input persistence is now handled centrally in ui.js via Persistence.saveConfig()
