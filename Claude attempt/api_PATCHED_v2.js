...
window.renderToVertexAI = async function (engineName, hardenedPrompt = "", startFrameUrl) {
    ...
    const endpoint = `https://${activeRegion}-aiplatform.googleapis.com/${v}/projects/${cleanPid}/locations/${activeRegion}/publishers/google/models/${modelId}:predictLongRunning`;
